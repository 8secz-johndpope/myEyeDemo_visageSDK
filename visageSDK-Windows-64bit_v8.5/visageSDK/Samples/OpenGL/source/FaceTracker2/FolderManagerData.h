#ifndef __FolderManagerData_h__
#define __FolderManagerData_h__


namespace VisageSDK
{
static const char AppWorkingFolder[200] = "Samples/data";
static const int nRequiredFiles = 34;
static const char RequiredFiles[nRequiredFiles][200]=
{
	"bdtsdata/FF/ff.dat",
	"bdtsdata/LBF/lv",
	...
	"jk_300.wfm",
	"jk_300.fdp",
	"DefaultConfiguration.txt",
	"Head Tracker.cfg",
	"Facial Features Tracker - High.cfg",
	"Facial Features Tracker - Low.cfg",
	"../OpenGL/data/background.jpg",
	"../OpenGL/data/logo.png",
	"../OpenGL/data/font.png"
};
}
#endif

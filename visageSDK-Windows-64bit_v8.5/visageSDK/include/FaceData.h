...
3D coordinates are available in global coordinate system or relative to the origin of the face (i.e. the point in the center between the eyes in the input image).
 ...
 width and height of the input image or the video frame, model rotation (#faceRotation) and translation (#faceTranslation) - this \if WIN_DOXY <a href="doc/ar-notes.cpp">\else <a href="../ar-notes.cpp">\endif example code</a> shows how to do this using OpenGL.
...
struct VISAGE_DECLSPEC FaceData
{
    ...
    */
    ...
    unsigned int exy_data[EXY_DATA_SIZE];

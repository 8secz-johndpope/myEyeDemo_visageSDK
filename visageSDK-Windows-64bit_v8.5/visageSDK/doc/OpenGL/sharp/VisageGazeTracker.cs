...
namespace VisageCSWrapper
{
    ...
    /// <tr><td>Each FaceData object populated by the track() function contains screen space gaze data for the current frame.</td>
    ...
    ///
    /// After the system is calibrated the estimation phase starts. Estimations are returned as part of FaceData objects obtained by calling the track() method, specifically in FaceData::gazeData.
    ///
    ...
    /// </summary>
    public ref class VisageGazeTracker : public VisageTracker
    {
        /// <summary>
        ...
        /// For further details see <a href="../VisageTracker Configuration Manual.pdf">VisageTracker Configuration Manual</a>.
        /// </summary>
        VisageGazeTracker(String trackerConfigFile);
        ...
        ///
        /// After the calibration is finished, screen space gaze position is obtained as a part of FaceData object passed to the track() function. The returned FaceData object contains gaze position stored in ScreenSpaceGazeData object, specifically in FaceData::GazeData.
